...
class TestOrder2:
    ...
    def test_successful_ordering_1(self, driver):
        ...
        order_pages.input_name('Константин')
        order_pages.input_surname('Константинов')
        order_pages.input_address('Улица-Улица-Улица')
        order_pages.click_input_subway()
        order_pages.click_list_subway_preob()
        order_pages.input_phone_number('+712312312312')
        order_pages.click_next_button()
        order_pages.click_input_rent()
        order_pages.click_list_rent_two()
        order_pages.input_date_month('01.06.2024')
        order_pages.click_black_checkbox()
        order_pages.input_comment('Позвони по номеру телефона')
